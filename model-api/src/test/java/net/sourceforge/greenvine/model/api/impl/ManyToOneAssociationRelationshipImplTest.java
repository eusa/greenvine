...
public class ManyToOneAssociationRelationshipImplTest {
    ...
    public void setUp() throws ModelException {
        ...
        ukCols.add(joinPk1.getName());
        ukCols.add(joinPk2.getName());
    ...
    public void testCreateValidBiDirectional() throws ModelException {
        ManyToOneAssociationRelationImpl relation = new ManyToOneAssociationRelationImpl("ownerField", ownerForeignKey.getName(), "inverseField", inverseForeignKey.getName(), catalog);
        ...
        ManyToOneAssociationField ownerField = ownerEntity.getManyToOneAssociation("ownerField");
        ...
        OneToManyAssociationField inverseField = inverseEntity.getOneToManyAssociation("inverseField");
    ...
    public void testCreateValidUniDirectional() throws ModelException {
        ManyToOneAssociationRelationImpl relation = new ManyToOneAssociationRelationImpl("ownerField", ownerForeignKey.getName(), inverseForeignKey.getName(), catalog);
