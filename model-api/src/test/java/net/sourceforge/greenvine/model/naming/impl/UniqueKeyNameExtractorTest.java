...
public class UniqueKeyNameExtractorTest {
    ...
    @Test
    public void testGetUniqueKeyName() throws ModelException {
        UniqueKeyNameExtractor helper = new UniqueKeyNameExtractor();
        ...
        Assert.assertEquals("UK_TEST_NAME1_UNIQUE", pkName.toString());
    }
