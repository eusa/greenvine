...
public class OneToManyAssociationRelationshipImplTest {
    ...
    public void setUp() throws ModelException {
        ...
        ukCols.add(joinPk3.getName());
        ukCols.add(joinPk4.getName());
    ...
    public void testCreateValidBiDirectional() throws ModelException {
        OneToManyAssociationRelationImpl relation = new OneToManyAssociationRelationImpl("ownerField", ownerForeignKey.getName(), "inverseField", inverseForeignKey.getName(), catalog);
        ...
        OneToManyAssociationField ownerField = ownerEntity.getOneToManyAssociation("ownerField");
        ...
        ManyToOneAssociationField inverseField = inverseEntity.getManyToOneAssociation("inverseField");
    ...
    public void testCreateValidUniDirectional() throws ModelException {
        OneToManyAssociationRelationImpl relation = new OneToManyAssociationRelationImpl("ownerField", ownerForeignKey.getName(), inverseForeignKey.getName(), catalog);
