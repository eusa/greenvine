...
public class OneToOneAssociationRelationshipImplTest {
    ...
    public void setUp() throws ModelException {
        ...
        this.catalog = new CatalogImpl("testCat", model, database);
        ...
        ukCols1.add(joinPk1.getName());
        ukCols1.add(joinPk2.getName());
        join.createUniqueKey("JOIN_UK1", ukCols1);
        SortedSet<CharSequence> ukCols2 = new TreeSet<CharSequence>();
        ukCols2.add(joinPk3.getName());
        ukCols2.add(joinPk4.getName());
    ...
    public void testCreateValidBiDirectional() throws ModelException {
        OneToOneAssociationRelationImpl relation = new OneToOneAssociationRelationImpl("ownerField", ownerForeignKey.getName(), "inverseField", inverseForeignKey.getName(), catalog);
        ...
        OneToOneAssociationField ownerField = ownerEntity.getOneToOneAssociation("ownerField");
        ...
        OneToOneAssociationField inverseField = inverseEntity.getOneToOneAssociation("inverseField");
    ...
    public void testCreateValidUniDirectional() throws ModelException {
        OneToOneAssociationRelationImpl relation = new OneToOneAssociationRelationImpl("ownerField", ownerForeignKey.getName(), inverseForeignKey.getName(), catalog);
