...
public class OneToOneRelationshipImplTest {
    ...
    public void setUp() throws ModelException {
        ...
        ukCols1.add(childFk1.getName());
        ukCols1.add(childFk2.getName());
    ...
    public void testCreateValidBiDirectional() throws ModelException {
        OneToOneRelationImpl relation = new OneToOneRelationImpl("ownerField", "inverseField", foreignKey.getName(), catalog);
        ...
        OneToOneChildField inverseField = inverseEntity.getOneToOneChild("inverseField");
    ...
    public void testCreateValidUniDirectional() throws ModelException {
        OneToOneRelationImpl relation = new OneToOneRelationImpl("inverseField", foreignKey.getName(), catalog);
