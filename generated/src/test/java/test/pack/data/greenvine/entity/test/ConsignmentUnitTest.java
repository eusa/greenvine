...
public class ConsignmentUnitTest {
    
    private Consignment defaultInstance;
    private Consignment randomInstance;
    private Consignment clone;
    private Consignment unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = ConsignmentTestUtils.createDefaultInstance();
        this.randomInstance = ConsignmentTestUtils.createRandomInstance();
        this.clone = ConsignmentTestUtils.clone(defaultInstance);
        this.unitialized = new Consignment();
