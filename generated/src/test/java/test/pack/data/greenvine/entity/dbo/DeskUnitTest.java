...
public class DeskUnitTest {
    
    private Desk defaultInstance;
    private Desk randomInstance;
    private Desk clone;
    private Desk unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = DeskTestUtils.createDefaultInstance();
        this.randomInstance = DeskTestUtils.createRandomInstance();
        this.clone = DeskTestUtils.clone(defaultInstance);
        this.unitialized = new Desk();
