...
public class StandUnitTest {
    ...
    private Stand defaultInstance;
    private Stand randomInstance;
    private Stand clone;
    private Stand unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = StandTestUtils.createDefaultInstance();
        this.randomInstance = StandTestUtils.createRandomInstance();
        this.clone = StandTestUtils.clone(defaultInstance);
        this.unitialized = new Stand();
