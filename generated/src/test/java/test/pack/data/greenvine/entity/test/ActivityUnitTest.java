...
public class ActivityUnitTest {
    ...
    private Activity defaultInstance;
    private Activity randomInstance;
    private Activity clone;
    private Activity unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = ActivityTestUtils.createDefaultInstance();
        this.randomInstance = ActivityTestUtils.createRandomInstance();
        this.clone = ActivityTestUtils.clone(defaultInstance);
        this.unitialized = new Activity();
