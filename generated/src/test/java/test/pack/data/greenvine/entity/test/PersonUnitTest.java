...
public class PersonUnitTest {
    ...
    private Person defaultInstance;
    private Person randomInstance;
    private Person clone;
    private Person unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = PersonTestUtils.createDefaultInstance();
        this.randomInstance = PersonTestUtils.createRandomInstance();
        this.clone = PersonTestUtils.clone(defaultInstance);
        this.unitialized = new Person();
