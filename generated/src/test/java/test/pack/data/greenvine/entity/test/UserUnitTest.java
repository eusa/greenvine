...
public class UserUnitTest {
    ...
    private User defaultInstance;
    private User randomInstance;
    private User clone;
    private User unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = UserTestUtils.createDefaultInstance();
        this.randomInstance = UserTestUtils.createRandomInstance();
        this.clone = UserTestUtils.clone(defaultInstance);
        this.unitialized = new User();
