...
public class BugUnitTest {
    ...
    private Bug defaultInstance;
    private Bug randomInstance;
    private Bug clone;
    private Bug unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = BugTestUtils.createDefaultInstance();
        this.randomInstance = BugTestUtils.createRandomInstance();
        this.clone = BugTestUtils.clone(defaultInstance);
        this.unitialized = new Bug();
