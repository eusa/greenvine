...
public class GroupUnitTest {
    ...
    private Group defaultInstance;
    private Group randomInstance;
    private Group clone;
    private Group unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = GroupTestUtils.createDefaultInstance();
        this.randomInstance = GroupTestUtils.createRandomInstance();
        this.clone = GroupTestUtils.clone(defaultInstance);
        this.unitialized = new Group();
