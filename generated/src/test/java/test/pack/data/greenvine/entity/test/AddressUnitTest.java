...
public class AddressUnitTest {
    ...
    private Address defaultInstance;
    private Address randomInstance;
    private Address clone;
    private Address unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = AddressTestUtils.createDefaultInstance();
        this.randomInstance = AddressTestUtils.createRandomInstance();
        this.clone = AddressTestUtils.clone(defaultInstance);
        this.unitialized = new Address();
