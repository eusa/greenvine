...
public class ContractUnitTest {
    ...
    private Contract defaultInstance;
    private Contract randomInstance;
    private Contract clone;
    private Contract unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = ContractTestUtils.createDefaultInstance();
        this.randomInstance = ContractTestUtils.createRandomInstance();
        this.clone = ContractTestUtils.clone(defaultInstance);
        this.unitialized = new Contract();
