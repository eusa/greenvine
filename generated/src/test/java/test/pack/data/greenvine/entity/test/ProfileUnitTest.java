...
public class ProfileUnitTest {
    ...
    private Profile defaultInstance;
    private Profile randomInstance;
    private Profile clone;
    private Profile unitialized;
    
    @Before
    public void doBefore() {
    
        this.defaultInstance = ProfileTestUtils.createDefaultInstance();
        this.randomInstance = ProfileTestUtils.createRandomInstance();
        this.clone = ProfileTestUtils.clone(defaultInstance);
        this.unitialized = new Profile();
